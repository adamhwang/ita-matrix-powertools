...
function printOA() {
  ...
  url += "&LANGUAGE=GB";
  // Amadeus WDS 18.x calls .filter() on this before its null-guard, so a null value breaks
  // angular.bootstrap (endless spinner). "seat" is inert; an empty value parses back to null.
  url += "&WDS_ENABLED_MIGRATED_STEPS=seat";
  url +=
